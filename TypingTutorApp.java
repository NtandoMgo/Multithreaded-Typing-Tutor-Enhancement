...
//shared class variables
	...
	public static HungryWord hWord; static HungryWordMover hWordShfts;
	//static	HungryWord hWord; static HungryWordMover hWordShft;
	...
	public static void createWordMoverThreads() {
		...
		hWordShfts = new HungryWordMover(hWord, dict, score, startLatch, done, pause);
		//hWordShft.start();
     	for (int i=0;i<noWords;i++) {
     		wrdShft[i] .start();
     	}
